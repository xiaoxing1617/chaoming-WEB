...
var _default = {
  ...
  methods: {
     ...
     * 获取一个随机的失踪儿童数据
     */
    getItemLossChildren: function getItemLossChildren() {
      var lossChildrens = this.globalData.lossChildrens;
      if (lossChildrens && lossChildrens.length >= 1) {
        // 生成一个随机索引
        var randomIndex = Math.floor(Math.random() * lossChildrens.length);
        // 使用随机索引来获取随机元素
        var randomElement = lossChildrens[randomIndex];
     ...
     * 获取失踪儿童列表数据
     */
    getLossChildrens: function getLossChildrens() {
      var _this2 = this;
      uni.request({
        ...
        success: function success(res) {
          var mergedArray = _this2.globalData.lossChildrens.concat(res.data.data.SuspectedLossChildrens);
          _this2.globalData.lossChildrens = mergedArray;
          var page = _this2.globalData.pageIndex;
          _this2.globalData.pageIndex = _this2.globalData.pageIndex + 1;
          if (res.data.data.totalPages > page && page < 5) {
            _this2.getLossChildrens();
          }
...
/***/ 30:
/*!*****************************************************************************************************************!*\
  !*** C:/Users/Aadministrator/Desktop/FilmQuickLook/ChaoMingBrushClass/App.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
